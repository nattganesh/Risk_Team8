...
public class ReinforcementControllerTest extends TestCase {
    ...
    /**
     * testing reinforcement from continent control when both player doesn't own
     * any continents
     */
    ...
    /**
     * testing reinforcement from continent control when both player owns 1
     * continents
     */
    ...
    /**
     * testing reinforcement from continent control when player1 owns 2
     * continents and other owns No continent
     */
